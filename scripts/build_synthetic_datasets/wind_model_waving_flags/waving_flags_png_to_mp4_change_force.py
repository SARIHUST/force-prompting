...
def create_mp4_from_frames(frames_dir):
    ...
    try:
        ...
        wind_speed1 = params.get("wind_speed_1", 0)
        wind_angle1 = params.get("wind_angle_1", 0)
        wind_speed2 = params.get("wind_speed_2", 0)
        wind_angle2 = params.get("wind_angle_2", 0)
    ...
    output_filename = f"flag_sample_{wind_speed1:.1f}_{wind_speed2:.1f}_0.0_{wind_angle1:.1f}_{wind_angle2:.1f}_0.0_background_{background_name}.mp4"
    ...
    try:
        cmd = [
            ...
            "-framerate", "24",
            "-start_number", "81",  # Start from frame 81
            "-i", frame_pattern,
            "-c:v", "libx264",
            "-pix_fmt", "yuv420p",
            output_path
